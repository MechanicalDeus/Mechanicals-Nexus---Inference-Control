...
| | |
|--|--|
| **Status** | **`0.1.1`** (`0.x` line) — inference-facing CLI and output shapes may still evolve within **minor** `0.x` releases; high-impact shifts are noted in **[`docs/patchnotes/`](docs/patchnotes/README.md)** and GitHub Releases (**Contract impact**). |
...
Pin a **tag** or **branch** with a suffix on the URL, e.g. `…Inference-Control.git@v0.1.1` or `…@main` (see [pip — VCS support](https://pip.pypa.io/en/stable/topics/vcs-support/)).
